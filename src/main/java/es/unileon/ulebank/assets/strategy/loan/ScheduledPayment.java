...
public class ScheduledPayment {
	...
	public ScheduledPayment(Date expiration, double importOfterm,
			...
			ScheduledPaymentHandler scheduledPaymentId) {
	...
	public double getAmountOfTerm() {
		return amountOfTerm;
	}

	public void setAmountOfTerm(double amountOfTerm) {
		this.amountOfTerm = amountOfTerm;
	}

	public Handler getScheduledPaymentId() {
		return scheduledPaymentId;
	}

	public void setScheduledPaymentId(Handler scheduledPaymentId) {
		this.scheduledPaymentId = scheduledPaymentId;
	}
